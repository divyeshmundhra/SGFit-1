...
import '../model/WeatherDetails.dart';
      ...
      body: Column(
          ...
          children: <Widget>[
            ...
            Row(children: <Widget>[
              ...
              Container(
              child: Text('CHANGE', style: TextStyle(color: Colors.white, fontSize: 13)),
              ...
              Container(
                  child: FlatButton(
                    ...
                    onPressed: () async {
                     ...
                     await prefs.setInt('waterconsumed', globals.waterconsumedi);
                     print('end');
                    },
                    disabledColor: Colors.white,
